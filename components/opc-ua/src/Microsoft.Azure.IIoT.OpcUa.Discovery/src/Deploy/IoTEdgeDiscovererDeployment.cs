...
namespace Microsoft.Azure.IIoT.Platform.Discovery.Deploy {
    ...
    /// </summary>
    public sealed class IoTEdgeDiscovererDeployment : IHostProcess {
        ...
        public IoTEdgeDiscovererDeployment(IDeviceDeploymentServices service,
